...
plot.surbar(x = x[1], stock = stock, psim = x.psim.stock, psim.s = x.psim.s, psim.f = x.psim.f, psim.r = x.psim.r, 
...
plot.surbar(x = x[2], stock = stock, psim = x.psim.stock, psim.s = x.psim.s, psim.f = x.psim.f, psim.r = x.psim.r, 
